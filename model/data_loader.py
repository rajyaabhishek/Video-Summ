...
class VideoData(Dataset):
    def __init__(self, mode, video_type, split_index):
        ...
        self.datasets = ['C:/Users/abhis/OneDrive/Desktop/video summarization/CA-SUM-main/data/SumMe/eccv16_dataset_summe_google_pool5.h5',
                         'C:/Users/abhis/OneDrive/Desktop/video summarization/CA-SUM-main/data/TVSum/eccv16_dataset_tvsum_google_pool5.h5']
        self.splits_filename = ['C:/Users/abhis/OneDrive/Desktop/video summarization/CA-SUM-main/data/splits/' + self.name + r'_splits.json']
